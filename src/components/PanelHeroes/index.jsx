...
const PanelHeroes = ({ searchValue, searchByName, heroes, addHeroToSquad, deleteHero, showHeroInfo, classes }) => (
...
export default withStyles(styles)(PanelHeroes);
